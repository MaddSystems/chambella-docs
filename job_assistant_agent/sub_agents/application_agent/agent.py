...
def get_available_interview_slots(tool_context: ToolContext) -> dict:
    ...
    try:
        ...
        # Store job title for use in responses
        job_title = job_data.get("Puesto") or job_data.get("Nombre_de_vacante", f"Vacante ID {job_id}")
...
def apply_to_job(tool_context: ToolContext) -> dict:
    ...
    job_title = job_details.get("Puesto") or job_details.get("Nombre_de_vacante", f"Vacante ID {job_id_to_apply}")
